...
public class Interstitial implements MRAIDListener {
    ...
    private void initImageWebView(Placement placement){
        ...
        webView.loadDataWithBaseURL("http://ssp-r.phunware.com", getImageMarkup(placement), "text/html", "UTF-8", "");
    }
    ...
    private void initWebView(String body){
        ...
        webView.loadDataWithBaseURL("http://ssp-r.phunware.com", body, "text/html", "UTF-8", "");
    }
