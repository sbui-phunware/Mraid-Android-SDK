...
//    }
    ...
    private void refresh(){
        ...
        Phunware.getInstance().requestPlacement(placementRequest.config, responseListener);
    }
    ...
    private void initWebViewCommon(WebView view, String body){
        ...
        view.loadDataWithBaseURL("http://ssp-r.phunware.com", body, "text/html", "UTF-8", "");
    }
    ...
    private void webViewLayoutChanged(View v, int left, int top, int right, int bottom, int oldLeft, int oldTop, int oldRight, int oldBottom){
        Log.i("Phunware" , String.format("onLayoutChanged left=%d right=%d top=%d bottom=%d", left, right, top, bottom));
    ...
    private void initWebClient(WebView view){
        ...
        view.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                if(url.contains("ssp-r.phunware.com")){
                    return false;
                }
