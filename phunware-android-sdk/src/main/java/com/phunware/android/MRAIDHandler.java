...
public class MRAIDHandler {
    ...
    private void expand(String url){
        Log.d("Ads/Phunware", "MRAID :: expand");
    ...
    private void resize(){
        Log.d("Ads/Phunware", "MRAID :: resize");
    ...
    private void close(){
        Log.d("Ads/Phunware", "MRAID :: close");
        isExpanded = false;
        if(closeButton != null){
    ...
    private void playVideo(String url){
        Log.d("Ads/Phunware", "MRAID :: playVideo");
    ...
    private void createPhoto(String args){
        Log.d("Ads/Phunware", "MRAID :: storePhoto");
        photoURL = args;
    ...
    private void createCalendarEvent(String args){
        Log.d("Ads/Phunware", "MRAID :: createCalendarEvent");
        Gson gson = new GsonBuilder().create();
    ...
    private void setExpandProperties(String args){
        Log.d("Ads/Phunware", "MRAID :: setExpandProperties");
        Gson gson = new GsonBuilder().create();
    ...
    private void setResizeProperties(String args){
        Log.d("Ads/Phunware", "MRAID :: setResizeProperties");
        Gson gson = new GsonBuilder().create();
    ...
    private void setOrientationProperties(String args){
        Log.d("Ads/Phunware", "MRAID :: setOrientationProperties");
        Gson gson = new GsonBuilder().create();
