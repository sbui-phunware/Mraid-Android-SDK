...
public class BannerView extends Fragment {
     ...
     *
     * @param accountID Your Phunware Account ID.
     * @param zoneID The Zone you'd like a placement from.
     * @param position A string representing the screen location at which to show the banner I.E BOTTOM_CENTER.  (com.phunware.android.Positions)
