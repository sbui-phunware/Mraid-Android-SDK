...
/**
 * An ad view for the Phunware SDK
 *
...
class PhunwareBannerView extends WebView {
    ...
    /**
     * Create a new {@link PhunwareBannerView}.
     *
     * @param context An Android {@link Context}.
     */
    public PhunwareBannerView(Context context) {
        super(context);
    }
    ...
    public void fetchAd(AdRequest request) {
        ...
        final PhunwareBannerView adView = this;
            ...
            public void success(PlacementResponse response) {
                ...
                if (null == placement) {
                    ...
                    if (placement.getBody().length() > 0) {
                        ...
                        Log.d("Ads/Phunware", "Placement response was not in an expected format, serving a blank.");
                    }
                    ...
                    try {
                        ...
                        Log.d("Ads/Phunware", "Loading ad markup into view.");
                        adView.loadDataWithBaseURL("http://ssp-r.phunware.com", markup, "text/html; charset=utf-8", "UTF-8", null);
