...
/**
 * Makes requests against the Phunware API.
 */
public class Phunware {
    ...
    protected void init(Context context) {
        ...
        Log.d("Ads/Phunware", "Initializing Phunware SDK v" + BuildConfig.VERSION_NAME);
        ...
        if (null == context) {
            ...
            try {
                ...
                Log.d("Ads/Phunware", "Initialization failed to load the client AdvertisingId, proceeding without it.");
            }
        }
    }
    ...
    public void requestPixel(String url) {
        ...
        call.enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                Log.d("Ads/Phunware", "Pixel Request [success=" + response.isSuccessful() + "]: " + _url);
                // :)
            }

            @Override
            public void onFailure(Call<ResponseBody> call, Throwable t) {
                Log.d("Ads/Phunware", "Pixel Request [success=false]: " + _url);
                t.printStackTrace();
                // :)
            }
        });
    ...
    private String buildConfigParam(PlacementRequestConfig config) {
        ...
        Log.d("Ads/Phunware", "QUERY: " + urlString);
